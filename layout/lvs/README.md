...
- `status: "mismatch"`, `mismatch_count: 17`, `category_counts: {"topology":
  ...
  cascading).
- Matched nets/pins **333/333**, unchanged. The layout-side `nets` (771) and
  `pins` (70) figures differ from the 2026-08-14 report's (1214 / 68)
  because the layout netlist itself was regenerated by issue #83 with
